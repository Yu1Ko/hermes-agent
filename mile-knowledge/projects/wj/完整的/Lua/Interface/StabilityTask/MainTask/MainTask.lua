...
-- 根据名称载入脚本
function TaskRead.loadTask(strTaskName)
    local tbTargetPointTable = {}
    print(SearchPanel.szCurrentInterfacePath.."MainTask/Task/"..strTaskName..".tab")
    for line in io.lines(SearchPanel.szCurrentInterfacePath.."MainTask/Task/"..strTaskName..".tab","b") do
    ...
    for key, value in pairs(TaskRead.tbTask) do
        print(key,value)
    end
end
...
Timer.AddCycle(CloseTeach,1,function ()
