-- ---------------------------------------------------------------------------------
-- Author: Unknown
-- Name: UIArenaFinishBattleDataPage
-- Date: 2022-12-15 10:29:08
-- Desc: ?
-- ---------------------------------------------------------------------------------

local UIArenaFinishBattleDataPage = class("UIArenaFinishBattleDataPage")

function UIArenaFinishBattleDataPage:OnEnter(tbData)
    self.tbData = tbData
...
function UIArenaFinishBattleDataPage:OnExit()
    self.bInit = false
end

function UIArenaFinishBattleDataPage:BindUIEvent()

end

function UIArenaFinishBattleDataPage:RegEvent()
    --Event.Reg(self, EventType.XXX, func)
end

function UIArenaFinishBattleDataPage:UpdateInfo()
    self:UpdateSelfInfo()
    self:UpdateEnemyInfo()
end

function UIArenaFinishBattleDataPage:UpdateSelfInfo()
...
function UIArenaFinishBattleDataPage:UpdateEnemyInfo()
...
return UIArenaFinishBattleDataPage