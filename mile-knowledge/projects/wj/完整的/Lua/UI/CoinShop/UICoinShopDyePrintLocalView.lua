-- ---------------------------------------------------------------------------------
-- Author: Unknown
-- Name: UICoinShopDyePrintLocalView
-- Date: 2023-10-18 19:59:16
-- Desc: ?
-- ---------------------------------------------------------------------------------

local UICoinShopDyePrintLocalView = class("UICoinShopDyePrintLocalView")

function UICoinShopDyePrintLocalView:OnEnter(funcCallback)
    ...
    self.szCurPath = nil
    self.tbSelectedPath = {}
    self.szLocalDir = HairDyeingData.ExportedFolder()
...
function UICoinShopDyePrintLocalView:OnExit()
    self.bInit = false
end

function UICoinShopDyePrintLocalView:BindUIEvent()
...
function UICoinShopDyePrintLocalView:RegEvent()

end

function UICoinShopDyePrintLocalView:UpdateInfo()
...
function UICoinShopDyePrintLocalView:UpdateBtnInfo()
...
function UICoinShopDyePrintLocalView:ClearSelected()
    for i, cell in ipairs(self.tbCells) do
...
return UICoinShopDyePrintLocalView