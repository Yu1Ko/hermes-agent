-- ---------------------------------------------------------------------------------
-- Author: Unknown
-- Name: UIBuildFacePrintLocalView
-- Date: 2023-10-18 19:59:16
-- Desc: ?
-- ---------------------------------------------------------------------------------

local UIBuildFacePrintLocalView = class("UIBuildFacePrintLocalView")

function UIBuildFacePrintLocalView:OnEnter(funcCallback)
...
function UIBuildFacePrintLocalView:OnExit()
    self.bInit = false
end

function UIBuildFacePrintLocalView:BindUIEvent()
...
function UIBuildFacePrintLocalView:RegEvent()

end

function UIBuildFacePrintLocalView:UpdateInfo()
...
function UIBuildFacePrintLocalView:UpdateBtnInfo()
...
function UIBuildFacePrintLocalView:ClearSelected()
    for i, cell in ipairs(self.tbCells) do
...
return UIBuildFacePrintLocalView