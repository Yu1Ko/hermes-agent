...
local bFlag = true
local szFilePath=SearchPanel.szInterfacePath.."ShopErgodic/ShopMation.ini"
...
SearchPanel.tbModule['AutoLogin'].SetAutoLoginInfo(nil,RandomString(8),'纯阳','成男')   -- 设置登录任务七秀成女
--读取tab的内容
