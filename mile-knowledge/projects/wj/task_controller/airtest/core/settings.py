...
class Settings(object):
    ...
    #CVSTRATEGY = ["tpl","surf", "brisk"]  # keypoint matching: kaze/brisk/akaze/orb, contrib: sift/surf/brief
    #CVSTRATEGY = ["surf", "brisk"]
    #CVSTRATEGY = ["brisk"]  # keypoint matching: kaze/brisk/akaze/orb, contrib: sift/surf/brief
