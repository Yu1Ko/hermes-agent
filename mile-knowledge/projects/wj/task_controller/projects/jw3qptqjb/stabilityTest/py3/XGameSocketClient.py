...
if __name__ == '__main__':
    ...
    print(strIpAddress)
    # 初始化SDK
    SDK = XGameSocketClient(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'SocketClientDLL.dll'),
                            strIpAddress, 1112, strMachineTag='Android',bTestFlag=True)
    # SDK

    SDK.PerfDataCreate()
    SDK.PerfDataStart()
    #time.sleep(2000)
    #strCMD='/cmd UIClickDebugger.Enable()'
    #strCMD = '/cmd UINodeControl.BtnTrigger("BtnRandom","WidgetInfo01")'
    ...
    #SDK.SendCommandToSDK(strCMD)
    #SDK.SetEngineOption(EngineOption.EO_animation_set_extract_frame_enable,0,False)
    #SDK.SetEngineOption(EngineOption.EO_basic_set_shadow_quality_int,1,0)
    time.sleep(20)
    SDK.PerfDataStop()
    #SDK.SetEngineOption(EngineOption.EO_debug_set_offlinegi_enable, 0, False)
