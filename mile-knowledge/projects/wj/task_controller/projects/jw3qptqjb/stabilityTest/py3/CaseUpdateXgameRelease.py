...
class CaseUpdateXgameRelease(CaseJX3SvnUpdate):
    def __init__(self):
        super(CaseUpdateXgameRelease, self).__init__()
    ...
    def set_work_path(self, dic_args):
        ...
        if 'Android' == self.tagMachineType:
            ...
            self.svnPath = 'svn://10.11.8.138/jx3test/Asan/Pak_Xgame_Andriod_Release'
