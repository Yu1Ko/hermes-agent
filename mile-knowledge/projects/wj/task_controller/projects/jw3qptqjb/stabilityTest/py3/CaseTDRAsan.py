...
class CaseTDRAsan(CaseAsanJX3SearchPanel):
    ...
    def processSearchPanelTab(self, dic_args):
        ...
        if self.runMapType=='Dungeons':
            ...
            strLocalPath=f"TempFolder{os.sep}Interface{os.sep}{self.runMapType}{os.sep}RunMapTask.tab"
        ...
        if 'robot' in dic_args:
            ...
            tmp = os.path.join('TempFolder', 'Interface', self.runMapType,'RunMap.tab')
