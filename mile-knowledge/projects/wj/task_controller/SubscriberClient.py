...
class SubscriberClient:
    ...
    def __init__(self, server_ip: str = "iqb.testplus.cn", server_port: int = 12501):
        """
        初始化客户端
    ...
    def _send(self, msg: dict):
        ...
        def _thread_send():
            ...
            [WinError 10061]异常： 连接被拒绝，服务端可能已被关闭或此客户端已被加入黑名单,请注意发送频率
            """
            # 连接到服务器
        ...
        thread1 = threading.Thread(target=_thread_send, daemon=True)
        thread1.start()
        thread1.join()
    ...
    def send_text(self, text, markdown=False):
        """
        发送纯文本消息

        :param text: 文本消息
        :param markdown: 是否为 markdown 文本消息 支持语法：[https://open-xz.wps.cn/pages/client/robot/custom-robot/#43cf76f7]
        """
        content = {
            "type": 1,
            "body": text
        ...
        self.send_custom_content(1, content)
        pass
...
if __name__ == '__main__':
    ...
    client.send_text_and_image("剑侠世界4","img.png")
